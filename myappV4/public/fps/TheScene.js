...
class TheScene extends Physijs.Scene {
  ...
  createHUD() {
    ...
    var tiltLR = document.createElement('div');
    tiltLR.id = "tiltLR";
    tiltLR.style.position = 'absolute';
    tiltLR.style.width = 1;
    tiltLR.style.height = 1;
    tiltLR.innerHTML = "tiltLR: 0";
    tiltLR.style.top = 200 + 'px';
    tiltLR.style.left = 50 + 'px';
    tiltLR.style.fontSize = 50 + 'px';
    tiltLR.style.color = "white";
    document.body.appendChild(tiltLR);

    var tiltFB = document.createElement('div');
    tiltFB.id = "tiltFB";
    tiltFB.style.position = 'absolute';
    tiltFB.style.width = 1;
    tiltFB.style.height = 1;
    tiltFB.innerHTML = "tiltFB: 0";
    tiltFB.style.top = 250 + 'px';
    tiltFB.style.left = 50 + 'px';
    tiltFB.style.fontSize = 50 + 'px';
    tiltFB.style.color = "white";
    document.body.appendChild(tiltFB);
  }
